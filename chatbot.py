...
async def main(message):
    ...
    # Extract the user's query from the message object
    query = message.content  # Get the text content of the message

    # Pass the query to the chain
    res = await chain.acall(query, callbacks=[cb])  # Pass the query (string) instead of the message object
    answer = res["result"]
